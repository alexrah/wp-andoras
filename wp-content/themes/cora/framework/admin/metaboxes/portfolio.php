...
$options_portfolio[] = array( "name" => "Subheading",
					"id" => "subheading",
					"std" => "",
					"type" => "text"); 
										
$options_portfolio[] = array( "name" => "Portfolio type",
					"id" => "type",
					"std" => "image",
					"options" => array(
					   "image",
...
$options_portfolio[] = array( "name" => "Fullsize Image URL for Lightbox",
                    "desc" => "if not specified the featured image will be use instead",
					"id" => "image_url",
					"std" => "",
					"type" => "text"); 
					
$options_portfolio[] = array( "name" => "Video URL for Lightbox",
                    "desc" => "full url of the Video (YouTube or Vimeo etc). Only necessary when the lightbox type is video.",
					"id" => "video_url",
					"std" => "",
					"type" => "text"); 
					
$options_portfolio[] = array( "name" => "Enable Read More",
                    "desc" => "if on, the read more button will show.",
					"id" => "read_more",
					"std" => "on",
					"options" => array(
					   "on",
...
$options_portfolio[] = array( "name" => "Slideshow Type",
					"id" => "slideshow_type",
...
$options_portfolio[] = array( "name" => "Slideshow Set",
					"id" => "slideshow_set",
...
$options_portfolio[] = array( "name" => "Slideshow Height (optional)",
					"id" => "slideshow_height",
					"desc"=> "choose the height of the slideshow images between 100 and 500",
					"std" => "",		
					"type" => "text");  
					
$options_portfolio[] = array( "name" => "Slideshow Captions (optional)",
...
function meta_options_portfolio($options_portfolio) {
	
	create_js_portfolio();
	
	global $options_portfolio,$post;
	
	$output= '<input type="hidden" name="mytheme_meta_box_nonce" value="'. wp_create_nonce(basename(__FILE__)). '" />';
        
    $counter = 0;
	$menu = '';
	foreach ($options_portfolio as $value) {
...
function create_meta_box_portfolio() {
	...
	add_meta_box( 'ps', 'Portfolio Settings', 'meta_options_portfolio', 'portfolio', 'normal', 'high' );
	}
}
